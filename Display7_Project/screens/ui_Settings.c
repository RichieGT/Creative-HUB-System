...
lv_obj_t *ui_Settings = NULL;lv_obj_t *ui_Group_Header5 = NULL;lv_obj_t *ui_Head_Group5 = NULL;lv_obj_t *ui_Label_Time6 = NULL;lv_obj_t *ui_LabeL_PM5 = NULL;lv_obj_t *ui_Label_Temp5 = NULL;lv_obj_t *ui_Label_Celsius5 = NULL;lv_obj_t *ui_Label_Battery5 = NULL;lv_obj_t *ui_Settings_Content = NULL;lv_obj_t *ui_Roller = NULL;lv_obj_t *ui_Roller1 = NULL;lv_obj_t *ui_Brightness_Group = NULL;lv_obj_t *ui_Brightness_Label = NULL;lv_obj_t *ui_Slider2 = NULL;lv_obj_t *ui_Brightness_Percent = NULL;lv_obj_t *ui_Volum_On = NULL;lv_obj_t *ui_Volume_Off = NULL;lv_obj_t *ui_Menu1 = NULL;lv_obj_t *ui_BTN_Settings1 = NULL;lv_obj_t *ui_Chart_Group = NULL;lv_obj_t *ui_Chart_Label = NULL;lv_obj_t *ui_Panel1 = NULL;lv_obj_t *ui_chart_scrollbar = NULL;lv_obj_t *ui_Chart2 = NULL;lv_obj_t *ui_Chart2_Xaxis = NULL;lv_obj_t *ui_Chart2_Yaxis1 = NULL;lv_obj_t *ui_Chart2_Yaxis2 = NULL;lv_obj_t *ui_Panel2 = NULL;lv_obj_t *ui_Group_Max_Speed1 = NULL;lv_obj_t *ui_Label_Max_Speed1 = NULL;lv_obj_t *ui_Label_Max_Speed_Number1 = NULL;lv_obj_t *ui_Label_kmh4 = NULL;lv_obj_t *ui_Group_AVG_Speed1 = NULL;lv_obj_t *ui_Label_AVG_Speed1 = NULL;lv_obj_t *ui_Label_AVG_Speed_Number1 = NULL;lv_obj_t *ui_Label_kmh5 = NULL;lv_obj_t *ui_Label_Number6 = NULL;
// event funtions
...
lv_obj_set_style_bg_color(ui_comp_get_child(ui_Roller, UI_COMP_ROLLER_ROLLER2), lv_color_hex(0x3179CD), LV_PART_SELECTED | LV_STATE_DEFAULT );
...
lv_obj_set_style_text_font(ui_comp_get_child(ui_Roller1, UI_COMP_ROLLER_ROLLER2), &ui_font_Medium, LV_PART_SELECTED| LV_STATE_DEFAULT);
lv_obj_set_style_bg_color(ui_comp_get_child(ui_Roller1, UI_COMP_ROLLER_ROLLER2), lv_color_hex(0x3179CD), LV_PART_SELECTED | LV_STATE_DEFAULT );
lv_obj_set_style_bg_opa(ui_comp_get_child(ui_Roller1, UI_COMP_ROLLER_ROLLER2), 255, LV_PART_SELECTED| LV_STATE_DEFAULT);
...
if (lv_obj_get_style_pad_top(ui_Slider2,LV_PART_MAIN) > 0) lv_obj_set_style_pad_right( ui_Slider2, lv_obj_get_style_pad_right(ui_Slider2,LV_PART_MAIN) + 1, LV_PART_MAIN );
...
lv_chart_series_t* ui_Chart2_series_1 = lv_chart_add_series(ui_Chart2, lv_color_hex(0x3392FF), LV_CHART_AXIS_PRIMARY_Y);
